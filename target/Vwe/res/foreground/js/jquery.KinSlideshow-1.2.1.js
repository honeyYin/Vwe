...
$.fn.KinSlideshow = function(settings){
	  ...
	  settings = jQuery.extend({
		   ...
		   isHasTitleBar:true,
		   titleBar:{titleBar_height:0,titleBar_alpha:0.0},
		   isHasTitleFont:true,
	  ...
	  var titleBar_Bak = {titleBar_height:0,titleBar_bgColor:"#ffffff",titleBar_alpha:0.5}
	 ...
	 function KSS_setTitleBar(){
		...
		$(ksbs+" .KSS_titleBar").css({height:getTitleBar_Height,width:960,position:"absolute",bottom:5,left:0})
	 ...
	 function KSS_setTitleFont(){
		 if(settings.isHasTitleFont){
			$(ksthis).append("<div class='KSS_titleBox'><h2 class='title' style='margin:0px 0px 0px 10px;padding:0;'></h2></div>");
			$(ksbs+" .KSS_titleBox").css({height:getTitleBar_Height,width:"165px",position:"absolute",bottom:-8,left:0})
	 ...
	 function KSS_setBtn(){
		 ...
		 if(settings.isHasBtn && KSS_imgaeLength >= 2){
			 $(ksthis).append("<div class='KSS_btnBox' style='position:absolute;right:5px;bottom:16px; z-index:100'></div>");
			 var KSS_btnList = "";
